...
아래 링크를 우측 마우스 메뉴에서 새로운 탭으로 여세요.  
그리고 내용을 참조하여 필요한 툴을 설치하세요.  
...
## Azure 리소스 관리   
아래는 참고용으로 기록한 것이니 수행 하지 마세요.    

**테넌트(디렉토리)관리**     
MicroSoft Entra ID 선택 > 우측에서 '테넌트관리' 클릭    

**디렉토리 전환하기**       
![](images/2025-11-04-18-12-16.png)

**디렉토리 간 리소스 이동**         
![](images/2025-11-04-18-10-39.png)


**사용자등록**    
MicroSoft Entra ID 선택 > 사용자 클릭    

![](images/2025-11-04-18-32-01.png)  

**사용자 권한 부여**     
구독 클릭 > 액세스 제어(IAM) 클릭 > 추가 > 역할 할당 추가 
![](images/2025-11-04-18-34-28.png)

![](images/2025-11-04-18-35-04.png)   
